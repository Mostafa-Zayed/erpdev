...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"quod","ip_address":"doloribus","latitude":"nam","longitude":"ipsa"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"consectetur","latitude":"officiis","longitude":"quae"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/holidays?location_id=harum&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=eligendi&follow_up_type=nam&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=modi&biz_name=eos&mobile_num=2&contact_id=sed&order_by=expedita&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"necessitatibus","mobile_name":"voluptatum","call_type":"call","start_time":"dolorem","end_time":"esse","duration":"et"}]}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=dolor&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":4,"initial_amount":75425.38,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":1455.718,"total_card_slips":2,"total_cheques":5,"closing_note":"vel","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=aspernatur&name=maiores&biz_name=recusandae&mobile_num=6&contact_id=mollitia&order_by=nisi&direction=eum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"voluptatem","prefix":"deserunt","first_name":"qui","middle_name":"quae","last_name":"ea","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"sequi","address_line_2":"repellendus","city":"aut","state":"ea","country":"et","zip_code":"corrupti","customer_group_id":"sit","contact_id":"atque","dob":"2000-06-13","custom_field1":"quo","custom_field2":"et","custom_field3":"assumenda","custom_field4":"nisi","email":"maxime","shipping_address":"voluptatum","position":"error","opening_balance":0,"source_id":9,"life_stage_id":20,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_2": "repellendus",
    "city": "aut",
    "state": "ea",
    "country": "et",
    "zip_code": "corrupti",
    "customer_group_id": "sit",
    "contact_id": "atque",
    "dob": "2000-06-13",
    "custom_field1": "quo",
    "custom_field2": "et",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"molestiae","prefix":"similique","first_name":"aut","middle_name":"doloremque","last_name":"esse","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"qui","address_line_2":"iusto","city":"nobis","state":"aut","country":"ea","zip_code":"quam","customer_group_id":"velit","contact_id":"impedit","dob":"2000-06-13","custom_field1":"quos","custom_field2":"eligendi","custom_field3":"non","custom_field4":"et","email":"doloribus","shipping_address":"qui","position":"laborum","opening_balance":10.3,"source_id":9,"life_stage_id":6,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "molestiae",
    "prefix": "similique",
    "first_name": "aut",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":18,"card_number":"facere","card_holder_name":"impedit","card_transaction_number":"autem","card_type":"aperiam","card_month":"pariatur","card_year":"incidunt","card_security":"eius","transaction_no_1":"consequatur","transaction_no_2":"et","transaction_no_3":"praesentium","cheque_number":"provident","bank_account_number":"et","note":"culpa"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=fugit&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=quia&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":6,"final_total":3193.224,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":15,"expense_for":10,"contact_id":2,"additional_notes":"asperiores","is_refund":0,"is_recurring":0,"recur_interval":11,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"qui","recur_repetitions":5,"payment":[{"amount":453.13,"method":"cash","account_id":3,"card_number":"sed","card_holder_name":"repellat","card_transaction_number":"enim","card_type":"ex","card_month":"suscipit","card_year":"iure","card_security":"expedita","transaction_no_1":"et","transaction_no_2":"eum","transaction_no_3":"quo","note":"soluta","cheque_number":"maxime"}]}'
...
let body = {
    "location_id": 6,
    "final_total": 3193.224,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 15,
    "expense_for": 10,
    "contact_id": 2,
    "additional_notes": "asperiores",
    "is_refund": 0,
    "is_recurring": 0,
    "recur_interval": 11,
    ...
    "payment": [
        {
            ...
            "account_id": 3,
            "card_number": "sed",
            "card_holder_name": "repellat",
            "card_transaction_number": "enim",
            "card_type": "ex",
            "card_month": "suscipit",
            "card_year": "iure",
            "card_security": "expedita",
            "transaction_no_1": "et",
            "transaction_no_2": "eum",
            "transaction_no_3": "quo",
            "note": "soluta",
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":42051415.10314974,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":10,"contact_id":12,"additional_notes":"dolore","is_recurring":0,"recur_interval":2,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"distinctio","recur_repetitions":16,"payment":[]}'
...
let body = {
    "final_total": 42051415.10314974,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 20,
    "expense_for": 10,
    "contact_id": 12,
    "additional_notes": "dolore",
    "is_recurring": 0,
    "recur_interval": 2,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
    "subscription_no": "distinctio",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=dignissimos&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=ab&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=qui&order_direction=totam&brand_id=sequi&category_id=voluptates&sub_category_id=iste&location_id=pariatur&selling_price_group=rerum&name=quia&sku=quisquam&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=quos" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=est&location_id=omnis&brand_id=eum&category_id=et&sub_category_id=nisi&not_for_selling=rem&name=aperiam&sku=dolorum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=sed&contact_id=sapiente&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=aliquid&service_staff_id=quia&shipping_status=ordered&only_subscriptions=sunt&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":4,"contact_id":20,"transaction_date":"2020-07-22 15:48:29","invoice_no":"earum","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":16,"discount_amount":10,"discount_type":"fixed","sale_note":"ducimus","staff_note":"provident","commission_agent":17,"shipping_details":"Express Delivery","shipping_address":"qui","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":1,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"aperiam","recur_repetitions":17,"rp_redeemed":11,"rp_redeemed_amount":13.5,"types_of_service_id":17,"service_custom_field_1":"voluptas","service_custom_field_2":"rerum","service_custom_field_3":"porro","service_custom_field_4":"temporibus","service_custom_field_5":"blanditiis","service_custom_field_6":"id","round_off_amount":37265.7,"table_id":4,"service_staff_id":8,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":13,"note":"voluptas"}],"payments":[{"amount":453.13,"method":"cash","account_id":20,"card_number":"ex","card_holder_name":"quae","card_transaction_number":"ex","card_type":"corrupti","card_month":"illum","card_year":"voluptatem","card_security":"veniam","transaction_no_1":"asperiores","transaction_no_2":"et","transaction_no_3":"corporis","bank_account_number":"quidem","note":"necessitatibus","cheque_number":"voluptatum"}]}]}'
            ...
            "payments": [
                {
                    ...
                    "account_id": 20,
                    "card_number": "ex",
                    "card_holder_name": "quae",
                    "card_transaction_number": "ex",
                    "card_type": "corrupti",
                    "card_month": "illum",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":13,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":2,"discount_amount":10,"discount_type":"fixed","sale_note":"et","staff_note":"dolores","sells":[{"is_suspend":false}],"commission_agent":18,"shipping_details":"Express Delivery","shipping_address":"reiciendis","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":9,"pay_term_number":13,"pay_term_type":"months","is_recurring":0,"recur_interval":4,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"atque","recur_repetitions":15,"rp_redeemed":12,"rp_redeemed_amount":13.5,"types_of_service_id":4,"service_custom_field_1":"sit","service_custom_field_2":"aut","service_custom_field_3":"doloremque","service_custom_field_4":"nemo","service_custom_field_5":"fugiat","service_custom_field_6":"expedita","round_off_amount":131397.03717769,"table_id":8,"service_staff_id":3,"change_return":0,"change_return_id":9,"products":[{"sell_line_id":20,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":2,"discount_amount":0,"discount_type":"percentage","sub_unit_id":1,"note":"qui"}],"payments":[{"payment_id":9,"amount":453.13,"method":"cash","account_id":5,"card_number":"possimus","card_holder_name":"aut","card_transaction_number":"ab","card_type":"et","card_month":"officia","card_year":"fugiat","card_security":"dolor","transaction_no_1":"consequuntur","transaction_no_2":"neque","transaction_no_3":"est","note":"eum","cheque_number":"aut","bank_account_number":"quidem"}]}'
...
let body = {
    ...
    "service_custom_field_1": "sit",
    "service_custom_field_2": "aut",
    "service_custom_field_3": "doloremque",
    "service_custom_field_4": "nemo",
    "service_custom_field_5": "fugiat",
    "service_custom_field_6": "expedita",
    "round_off_amount": 131397.03717769,
    "table_id": 8,
    "service_staff_id": 3,
    "change_return": 0,
    "change_return_id": 9,
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/dolore" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":18,"transaction_date":"2020-5-7 15:20:22","invoice_no":"explicabo","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":19,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":6,"shipping_status":"ordered","delivered_to":"deserunt"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/table?location_id=accusantium" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=omnis" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"doloremque","first_name":"dolores","last_name":"sed","email":"at","is_active":"voluptate","user_type":"quia","crm_contact_id":11,"allow_login":false,"username":"eius","password":"doloribus","role":15,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"placeat","max_sales_discount_percent":"repellat","selected_contacts":false,"selected_contact_ids":[],"dob":"voluptas","gender":"sint","marital_status":"accusantium","blood_group":"consequatur","contact_number":"eveniet","alt_number":"commodi","family_number":"magnam","fb_link":"repudiandae","twitter_link":"quos","social_media_1":"possimus","social_media_2":"animi","custom_field_1":"nesciunt","custom_field_2":"sed","custom_field_3":"voluptatem","custom_field_4":"perferendis","guardian_name":"illum","id_proof_name":"ipsum","id_proof_number":"earum","permanent_address":"sed","current_address":"molestias","bank_details":[{"account_holder_name":"voluptas","account_number":"ut","bank_name":"doloremque","bank_code":"corrupti","branch":"eveniet","tax_payer_id":"recusandae"}]}'
...
let body = {
    ...
    "cmmsn_percent": "placeat",
    "max_sales_discount_percent": "repellat",
    ...
    "contact_number": "eveniet",
    "alt_number": "commodi",
    "family_number": "magnam",
    "fb_link": "repudiandae",
    "twitter_link": "quos",
    "social_media_1": "possimus",
    "social_media_2": "animi",
    "custom_field_1": "nesciunt",
    "custom_field_2": "sed",
    "custom_field_3": "voluptatem",
    "custom_field_4": "perferendis",
    "guardian_name": "illum",
    "id_proof_name": "ipsum",
    "id_proof_number": "earum",
    "permanent_address": "sed",
    "current_address": "molestias",
    "bank_details": [
        {
            "account_holder_name": "voluptas",
            "account_number": "ut",
            "bank_name": "doloremque",
            "bank_code": "corrupti",
            "branch": "eveniet",
            "tax_payer_id": "recusandae"
        }
    ]
}
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"tempora","new_password":"cum"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/profit-loss-report?location_id=est&start_date=2018-06-25&end_date=2018-06-25&user_id=est" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
