...
return [
    ...
    'job_sheets' => 'Job cards',
    'all_job_sheets' => 'Business sheet',
    'add_job_sheet' => 'Add job card',
    'job_sheet' => 'Job card',
    'create' => 'Create',
    ...
    'view_job_sheet' => 'View job card',
    'job_sheet_no' => 'Job card number',
    'job_sheet_prefix' => 'Job card number prefix',
    'technician' => 'Technician',
    'security_pattern' => 'Security Pattern',
    'customer_signature' => 'Customer signature',
    'authorized_signature' => 'Authorized signature',
    'security_pattern_code' => 'Security Pattern code',
    'edit_job_sheet' => 'Edit Job card',
    'delete_job_sheet' => 'Delete Job card',
    'view_all_job_sheet' => 'View All Job cards',
    'view_assigned_job_sheet' => 'View Only Assigned Job card',
    'pending' => 'Pending',
    'completed' => 'Completed',
    'invoices' => 'Invoices',
    ...
    'default_job_sheet_status' => 'Default Job card Status',
    'default_job_sheet_status_tooltip' => 'Default status when adding a new job card',
    'all_js_status_tooltip' => 'All job cards status',
    'edit_invoice' => 'Edit Invoice',
    'view_invoice' => 'View Invoice',
    'delete_invoice' => 'Delete Invoice',
    'change_invoice_status' => 'Change Invoice Status',
    'access_job_sheet_status' => 'Add/Edit/Delete Job card Status',
    'show_repair_status' => "Show repair status",
    'repair_status_label' => 'Repair status label',
    'pick_up_on_site_addr' => 'Pick up/On site address',
    'job_sheets_by_status' => 'Job cards by status',
    'job_sheets_by_service_staff' => 'Job cards by service staff',
    'total_job_sheets' => 'Total job cards',
    'job_sheet_or_invoice_no' => 'Job card no. / Invoice no.',
    'uploaded_image_for' => 'Uploaded docs for :job_sheet_no',
    'comment_by_ss' => 'Comment by technician',
    'send_notification' => 'Send notification',
    'sms' => 'Sms',
    'product_configuration_tooltip' => 'Add comma (,) separated multiple product configurations, to be used in job card <br> <b>Ex: </b>Item 1, Item 2, Item 3',
    'problem_reported_by_customer_tooltip' => 'Add comma (,) separated common problems reported by customer, to be used in job card <br> <b>Ex: </b>Item 1, Item 2, Item 3',
    'product_condition_tooltip' => 'Add comma (,) separated common product conditions, to be used in job card <br> <b>Ex: </b>Item 1, Item 2, Item 3',
    ...
    'label_for_job_sheet_custom_field' => 'Label for job card custom field :number',
    'add_jobsheet_parts' => 'Add job card parts',
    'add_parts' => 'Add parts',
    ...
    'upload_job_sheet_docs' => 'Upload job card docs',
    'upload_docs' => 'Upload docs',
    'document' => 'Car photos',
    'total_cash' => 'Cash',
    'car_plate' => 'Car plate no',
    'car_model' => 'Car Model',
    'Dents_insurance' => 'Dents insurance',
    'status' => 'Status',
    'serial' => 'Serial Number',
    'id_number' => 'Id Number',
    'pay_type' => 'Job card Type',
    'cash' => 'Cash',
    'excess' => 'Insurance',
    'both' => 'Both',
    'date_in' => 'Date In',
    ...
    'id_photo' => 'ID Photo',
    'd_license' => 'Drive License',
    'v_license' => 'Registration License',
    'car' => 'Car',
    'client_car' => 'Client Car',
    'pay_types' => 'Job card Type',
    ...
    'cash_desc' => 'Cash Desc',
    'insurance_desc' => 'Insurance Desc',
    'cash_cost' => 'Cash Cost',
    'company_name' => 'Company Name',
    'address' => 'Address',
    'phone' => 'Phone',
    'trn_no' => 'Tax Registration Number',
    'emails' => 'Emails',
    ...
    'all_job_card'=>'Business sheet',
    'all_total'=>'Job Cards',
    'stamp_and_signature'=>'Stamp and Signature',
    'repair_tc_condition_ar'=>'Terms and condeitions for RTL',
    'car_parts'=>'Car Parts',
    'amount'=>'Amount',
    'repair_days'=>'Estimated days',
    'save_and_send_quote'=>'Save and send',
    'print_estimation'=>'Print Estimation',
     'update_date'=>'Date entry',
     'days'=>'Working days',
    'Under_process'=>'Under process',
    'quote_submited'=>'Submit qoute',
    'LPO_pendig'=>'LPO Pending',
    'LPO_issued'=>'LPO Issued',
    'Under_repair'=>'Under repair',
    'Car_delivered'=>'Car Delivered',
    'paid_invoice'=>'Setteled',
    'papers'=>'Docs',
    'jobcard_photo'=>'Jobcard copy',
    'job_card_photo'=>'Jobcard copy',
    'ready_cars'=>'Ready Cars',
    'add_lpo'=>'Add LPO',
    ...
    'claim_no'=>'Claim NO',
    'lpo_date'=>'LPO date',
    'delivery_date_tooltip'=>'Delivery date',
    'select'=>'Select',
    "aed"=>'AED',
    "garage_module"=>'Garage Module',
    "stamp"=>'Stamp',
    "signature"=>'Signature',
    "print_cash"=>'Print cash invoice',
    "print_insurance"=>'Print insurance invoice',
    "payment_status"=>'Payment Status',
    "payment_methods"=>'Payment Method',
    "total_remaining"=>'Total Remaining',
    "total_paid"=>'Total Paid',
    "tax_amount"=>'Tax Amount',
    "total_before_tax"=>'Totla Before Tax',
    "final_total"=>'Final Total',
    "estimation_photo"=>'Estimation copy',
    "lpo_photo"=>'LPO copy',
    "receipt_photo"=>'Receipt copy',
    "invoice_photo"=>'Invoice copy',
    "car_work"=>'Car jobcard',
    "car_repairing"=>'car repairing',
    "cash_work"=>'Cash Work',
    "estimaition_amount"=>'Estimation Amount',
    "lpo_amount"=>'LPO Amount',
    "lpo_balance"=>'LPO Balance',
    "to_email"=>'Email to',
    "garage_invoice_footer"=>'Invoice footer',
    "notes"=>'Notes',
