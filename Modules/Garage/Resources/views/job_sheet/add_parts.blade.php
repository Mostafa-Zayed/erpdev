@extends('layouts.app')
@section('title', __('garage::lang.add_jobsheet_parts'))

@section('content')
@include('garage::layouts.nav')
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('garage::lang.add_jobsheet_parts')</h1>
</section>
...
<section class="content">
	...
	@endcomponent
	{!! Form::open(['url' => action('\Modules\Garage\Http\Controllers\JobSheetController@saveParts', $job_sheet->id), 'method' => 'post' ]) !!}
	@component('components.widget', ['class' => 'box-solid', 'title' => __('garage::lang.add_parts')])
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<div class="form-group">
					<div class="input-group">
						...
						{!! Form::text('search_product', null, ['class' => 'form-control', 'id' => 'search_job_sheet_parts', 'placeholder' => __('garage::lang.search_parts')]); !!}
					</div>
				</div>
			</div>
		</div>
					...
					<tbody>
						@if(!empty($parts))
							@foreach($parts as $part)
								@include('garage::job_sheet.partials.job_sheet_part_row', ['variation_name' => $part['variation_name'], 'unit' => $part['unit'], 'quantity' => $part['quantity'], 'variation_id' => $part['variation_id']])
							@endforeach
						@endif
					</tbody>
				</table>
	...
	@if(!empty($status_update_data) && $status_update_data['job_sheet_id'] == $job_sheet->id)
		@component('components.widget', ['class' => 'box-solid'])
			@include('garage::job_sheet.partials.edit_status_form', ['status_update_data' => $status_update_data])
		@endcomponent
	@endif
	<div class="row">
		<div class="col-sm-12">
