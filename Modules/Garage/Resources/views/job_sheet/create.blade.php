...
height: 20px;
    ...
    .step.active {
    	opacity: 1;
    	color: #0971fe;
    	border-bottom: 1px solid #0971fe;
    }
            ...
            <section class="container">
                <div class="form-group">
                    <div class="car-diagram-holder">
                        <canvas id="car-diagram" style="width: 596px; height: 298px;" width="596" height="298"></canvas>
                    </div>
...
<!--        //--------------------code ----------------------------------------  -->        
        ...
        <div class="pos-main-sec ct" >
            <div class="col-md-12">
                <div class="steps-head">
                    <span class="step">{{__('garage::lang.client_car')}}</span>
                  <!--  <span class="step">{{__('garage::lang.car')}}</span>-->
                    <span class="step">{{__('garage::lang.Dents_insurance')}}</span>
                    <span class="step">{{__('garage::lang.status')}}</span>
                </div>
                <!-- Start Tabs --> 
                ...
                <div class="tab" >
                   <div class="row" >
                        ...
                        @else
                            ...
                            @endphp
                        @endif
                        <div class="col-md-4 @if(!empty($default_location)) hide @endif">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('car_brand', $brands, null, ['class' => 'form-control select2 required', 'placeholder' => __('messages.please_select')]); !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('care_model', __('garage::lang.car_model') . ':') !!}
                                {!! Form::text('care_model', null, ['class' => 'form-control required', 'placeholder' => __('garage::lang.car_model'), 'required']); !!}               
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('car_plate', __('garage::lang.car_plate') . ':') !!}
                                 {!! Form::text('car_plate', null, ['class' => 'form-control required', 'placeholder' => __('garage::lang.car_plate'), 'required']); !!}                   
                             </div>
                        </div>
                    </div>
                   <!-- <div class="row">
                    ...
                    <section class="container">
                        <div class="form-group">
                          ...
                          <div class="signature-tool-item with-picker">
                                ...
                                <div class="signature-tool-item" id="undo">undo
                                    <div class="tool-icon tool-undo" ></div>
                                </div>
                                <div class="nk-divider divider mt-2 mb-2"></div>
        ...
        padding: 0;background-color: #1418FF;"></em> <span class="text-muted" style="color:#1418FF;">Scratch marking selected</span></p>
                            </div>
                            <div id="toolbar">
                                <button class="hide" id="clear">Clear</button>
                            </div>
                    ...
                    <p>Mark for dents and scratches. Use <span style="color:#ff0000;"><em class="icon ni ni-circle-fill"></em> Red color</span> for accident  and <span style="color:#1418FF;"><em class="icon ni ni-circle-fill"></em> Blue color</span> for dents. This can not be updated once saved.</p>
                </div>
                    </section>
                </div>
                <!--  <div class="tab">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('type', ['OD'=>'OD','TP'=>'TP','REC'=>'REC'], null, ['class' => 'form-control select2 required', 'placeholder' => __('messages.please_select'), 'required']); !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <label class="radio-inline">
                                {!! Form::radio('pay_types', 'cash', false, [ 'class' => 'input-icheck required', 'required']); !!}
                                @lang('garage::lang.cash')
                            </label>
                            <label class="radio-inline">
                                {!! Form::radio('pay_types', 'excess', false, [ 'class' => 'input-icheck']); !!}
                                @lang('garage::lang.excess')
                            </label>
                            <label class="radio-inline radio_btns">
                                {!! Form::radio('pay_types', 'both', false, [ 'class' => 'input-icheck']); !!}
                        ...
                        <div class="col-md-6" style="display: none;">
                            <div class="form-group">
                                ...
                                {!! Form::number('insurance_cost',0, ['class' => 'form-control ', 'id' => 'insurance_cost', 'placeholder' => __('garage::lang.insurance_cost'), 'rows' => 3]); !!}
                            </div>
                        </div> 
                        <div class="col-md-6 excess_company" style="display: none;">
                            <div class="form-group">
                                {!! Form::label('insurance_company_id', __('garage::lang.insurance_company') . ':') !!}
                               {!! Form::select('insurance_company_id', $devices, null, ['class' => 'form-control', 'placeholder' => __('messages.please_select')]); !!}
                            </div>
                        </div>
                        <div class="col-md-6 excess_desc" style="display: none;">
                            <div class="form-group">
                                {!! Form::label('insurance_desc', __('garage::lang.insurance_desc') . ':') !!}
                                {!! Form::textarea('insurance_desc',null, ['class' => 'form-control ', 'id' => 'insurance_desc', 'placeholder' => __('garage::lang.insurance_desc'), 'rows' => 3]); !!}
                            </div>
                        </div>
                        <div class="col-md-6 cash_desc" style="display: none;">
                            <div class="form-group">
                                {!! Form::label('cash_desc', __('garage::lang.cash_desc') . ':') !!}
                                {!! Form::textarea('cash_desc',null, ['class' => 'form-control ', 'id' => 'cash_desc', 'placeholder' => __('garage::lang.cash_desc'), 'rows' => 3]); !!}
                            </div>
                        </div>
                        <div class="col-md-6 cash_cost" style="display: none;">
                            <div class="form-group">
                                {!! Form::label('cash_cost', __('garage::lang.cash_cost') . ':') !!}
                                {!! Form::number('cash_cost',0, ['class' => 'form-control ', 'id' => 'cash_cost', 'placeholder' => __('garage::lang.cash_cost'), 'rows' => 3]); !!}
                            </div>
                        </div>
                        <div class="col-md-6 cash_cost" style="display: none;">
                            <div class="form-group">
                                {!! Form::label('deposit', __('garage::lang.deposit') . ':') !!}
                                {!! Form::number('deposit',0, ['class' => 'form-control ', 'id' => 'deposit', 'placeholder' => __('garage::lang.deposit'), 'rows' => 3]); !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('car_status', ['in'=>'in','out'=>'out'], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
                            </div>
                        </div> 
                        <!--<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('date_in', null, ['class' => 'form-control', 'id' => 'date_in', 'readonly']); !!}
                                    <span class="input-group-addon">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="status_id" class="form-control status required" id="status_id" required>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::file('police_report', ['id' => 'police_report','class' => 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                                <small>
                                    <p class="help-block">
                                        @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                        @includeIf('components.document_help_text')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::file('id_photo', ['id' => 'id_photo','class' => 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                                <small>
                                    <p class="help-block">
                                        @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                        @includeIf('components.document_help_text')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::file('d_license', ['id' => 'd_license','class' => 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                                <small>
                                    <p class="help-block">
                                        @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                        @includeIf('components.document_help_text')
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::file('v_license', ['id' => 'v_license','class' => 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                                <small>
                                    <p class="help-block">
                                        @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                        @includeIf('components.document_help_text')
         ...
         <div class="pos-main-sec ct">
               ...
               <div id="customer_data" style="width:100% !important"></div>
             ...
             <div class="row">
                  <div class="row col-md-12">
                        ...
                        <div class="form-group col-md-4">
                                {!! Form::label('new_contact', __('garage::lang.new_contact') .':*') !!}
                                <input type="checkbox" id="new_contact" name="new_contact" value="1" >
                            </div>
                            <div class="form-group col-md-4 show_new" style="display: none;">
        ...
        padding: 0;background-color: #1418FF;"></em> <span class="text-muted" style="color:#1418FF;">Scratch marking selected</span></p>
           ...
           <div class="pos-main-sec ct">
         <div class="row w-100">
                        <div class="col-md-4 excess_company" style="display: none;">
                            <div class="form-group">
                                {!! Form::label('type', __('garage::lang.type') . ':') !!}
                                {!! Form::select('type', ['OD'=>'OD','TP'=>'TP','REC'=>'REC'], null, ['class' => 'form-control  required', 'placeholder' => __('messages.please_select')]); !!}
                            </div>
                        </div>
                           <div class="col-md-4 hide">
                            <div class="form-group">
                                <label for="status_id">{{__('sale.status') . ':*'}}</label>
                                <select name="status_id" class="form-control status required" id="status_id" >
                                </select>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-md-12">
                         ...
                         <div class="col-md-6 excess_company" style="display: none;">
                            <div class="form-group">
                                ...
                                {!! Form::select('excess', ['yes'=>'yes','no'=>'no'], null, ['class' => 'form-control ', 'placeholder' => __('messages.please_select')]); !!}
                            </div>
                        </div>
                        <div class="col-md-6 " style="display: none;">
                            <div class="form-group">
                    ...
                    <div class="row col-md-12">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('police_report', __('garage::lang.police_report') . ':') !!}
                            {!! Form::file('police_report[]', ['id' => 'police_report', 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types'))) , 'multiple']); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('id_photo', __('garage::lang.id_photo') . ':') !!}
                            {!! Form::file('id_photo[]', ['id' => 'id_photo', 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types'))), 'multiple']); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('d_license', __('garage::lang.d_license') . ':') !!}
                            {!! Form::file('d_license[]', ['id' => 'd_license', 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types'))), 'multiple']); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::label('v_license', __('garage::lang.v_license') . ':') !!}
                            {!! Form::file('v_license[]', ['id' => 'v_license', 'required', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types'))), 'multiple']); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
           ...
           <div class="pos-main-sec ct cash_cost" style="display: none;">
         <div class="row w-100">
         ...
         <div class="row">
                       ...
                       <div class="col-md-12" >
                            <div class="form-group">
                                ...
                                {!! Form::textarea('notes',null, ['class' => 'form-control ', 'id' => 'notes', 'placeholder' => __('garage::lang.notes'), 'rows' => 6]); !!}
                            </div>
                        </div>
   ...
   <!--        //--------------------code ----------------------------------------  -->        
        ...
        {{--
        <div class="pos-main-sec ct">
            <div class="show-hide-pos-form">
                <h4>{{__('garage::lang.client_car')}}</h4>
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="col-lg-12 hidden-pos-form">
                <div class="row">
                    @if(count($business_locations) == 1)
                        @php 
                            $default_location = current(array_keys($business_locations->toArray()));
        ...
        <div class="pos-main-sec ct">
            <div class="show-hide-pos-form">
                <h4>{{__('garage::lang.Dents_insurance')}}</h4>
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="col-lg-12 hidden-pos-form">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('type', __('garage::lang.type') . ':') !!}
                            {!! Form::select('type', ['OD'=>'OD','TP'=>'TP','REC'=>'REC'], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-12">
                        ...
                        <br>
                        <label class="radio-inline">
                            {!! Form::radio('pay_types', 'cash', false, [ 'class' => 'input-icheck', 'required']); !!}
                            @lang('garage::lang.cash')
                        </label>
                        <label class="radio-inline">
                            {!! Form::radio('pay_types', 'excess', false, [ 'class' => 'input-icheck']); !!}
                    ...
                    <div class="col-md-6 excess_cost" style="display: none;">
                        <div class="form-group">
                            {!! Form::label('insurance_cost', __('garage::lang.insurance_cost') . ':') !!}
                            {!! Form::number('insurance_cost',0, ['class' => 'form-control ', 'id' => 'insurance_cost', 'placeholder' => __('garage::lang.insurance_cost'), 'rows' => 3]); !!}
                        </div>
            ...
            <div class="col-lg-12 hidden-pos-form">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('police_report', __('garage::lang.police_report') . ':') !!}
                            {!! Form::file('police_report', ['id' => 'police_report', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('id_photo', __('garage::lang.id_photo') . ':') !!}
                            {!! Form::file('id_photo', ['id' => 'id_photo', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('d_license', __('garage::lang.d_license') . ':') !!}
                            {!! Form::file('d_license', ['id' => 'd_license', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('v_license', __('garage::lang.v_license') . ':') !!}
                            {!! Form::file('v_license', ['id' => 'v_license', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                            <small>
                                <p class="help-block">
                                    @lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
                                    @includeIf('components.document_help_text')
...
<script>
    ...
    $(document).ready(function(){
         ...
         $('.ct .show-hide-pos-form').click(function(){
    ...
    <script  type="text/javascript">
              ...
              if ($(this).val() == 'cash') {
                ...
                $("div.excess_company").hide();
                  $("input.insurance_cost").val(0);
                     ...
                     $("#excess").prop('required',false);
     $("#insurance_company_id").prop('required',false);
     $("#type").prop('required',false);
                ...
                $("input.cash_cost").val(0);
                   $("#excess").prop('required',true);
     $("#insurance_company_id").prop('required',true);
