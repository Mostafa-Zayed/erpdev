  ...
  <!--  <div class="col-md-8">
        <div class="form-group">
            <div class="checkbox-inline">
                <label>
                    <input type="checkbox" name="send_sms" value="1" id="send_sms" @if(!empty($status_update_data['send_sms'])) checked @endif> @lang('garage::lang.send_sms')
                </label>
            </div>
            <div class="checkbox-inline">
                <label>
                    <input type="checkbox" name="send_email" value="1" id="send_email" @if(!empty($status_update_data['send_email'])) checked @endif> @lang('garage::lang.send_email')
                </label>
            </div>
        </div>
    </div>-->
