<div class="modal-dialog" role="document">
	<div class="modal-content">
		{!! Form::open(['url' => action('\Modules\Garage\Http\Controllers\JobSheetController@updateStatus', [$job_sheet->id]), 'method' => 'put', 'id' => 'update_status_form']) !!}
			...
			<div class="modal-body">
				...
				@include('garage::job_sheet.partials.edit_status_form')
			</div>
