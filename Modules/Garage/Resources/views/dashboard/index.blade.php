...
<section class="content content-custom no-print">
  ...
  <a href="{{action('\Modules\Garage\Http\Controllers\JobSheetController@create')}}" style="color:white">
	        <div class="home-info-box-content">
	          <span class="info-box-text">
	            
	            	@lang('garage::lang.add_job_sheet')
	    ...
	    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 col-custom">
	      <div class="home-info-box home-info-box-1">
	        <span class="home-info-box-icon"><i class="ion ion-cash"></i></span>
  <a href="{{action('\Modules\Garage\Http\Controllers\DashboardController@getStatusTotal')}}" style="color:white">
	        <div class="home-info-box-content">
	          <span class="info-box-text">{{ __('garage::lang.total_cash') }}</span>
	          <span class="info-box-number total_cash"><i class="fas fa-sync fa-spin fa-fw margin-bottom"></i></span>
	        </div>
	      </a>
	      </div>
  ...
  <a href="{{action('\Modules\Garage\Http\Controllers\DashboardController@getStatusTotal',$company->id)}}" style="color:white">
	        <div class="home-info-box-content">
