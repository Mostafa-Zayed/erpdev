<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('\Modules\Garage\Http\Controllers\GarageStatusController@store'), 'method' => 'post', 'id' => 'status_form']) !!}
            ...
            <div class="col-md-6 mt-15">
              ...
              <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::select('type', ['both'=>'both','cash'=>'cash','insurance'=>'insurance','repair'=>'repair'], null, ['class' => 'form-control select2 required']); !!}
                            </div>
                        </div>
        </div>
  <!--      <div class="row">
