...
@section('title', __('garage::lang.estimation'))
...
.tox .tox-toolbar--scrolling {
   ...
   .select2-container {
    ...
    .form-group label:first-child ~ .select2-container .select2-selection{
        width: 100% !important;
        max-width: 100% !important;
    }
    .tox-tinymce{
...
<!--        //--------------------code ----------------------------------------  -->        
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="hidden" name="service_staff" value="{{ request()->session()->get('user.id')}}" >
                                    <input type="hidden" name="estimation" value="1" >
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('car_brand', $brands, $job_sheet->car_brand, ['class' => 'form-control select2 w-100 required', 'placeholder' => __('messages.please_select')]); !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
        ...
        padding: 0;background-color: #1418FF;"></em> <span class="text-muted" style="color:#1418FF;">Scratch marking selected</span></p>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('type', ['OD'=>'OD','TP'=>'TP','REC'=>'REC'], $job_sheet->type, ['class' => 'form-control select2 w-100 required', 'placeholder' => __('messages.please_select'), 'required']); !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 hide">
                            ...
                            <label class="radio-inline">
                                {!! Form::radio('pay_types', 'cash', $job_sheet->pay_types == 'cash' ? true : false, [ 'class' => 'input-icheck required', 'required']); !!}
                ...
                @endif
                    ...
                    <div class="col-md-6 cash_cost" @if(!$cash) style="display: none;" @endif>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 cash_desc" @if(!$cash) style="display: none;" @endif>
                        <div class="form-group">
                    ...
                    <div class="col-md-6 col-12 excess_desc" @if(!$excess) style="display: none;" @endif>
                        <div class="form-group">
                ...
                <div class="tab last-tab">
                    <div class="row">
                        <!--  @if(in_array('service_staff' ,$enabled_modules))
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('service_staff', $technecians, null, ['class' => 'form-control select2 w-100', 'placeholder' => __('restaurant.select_service_staff')]); !!}
                                </div>
                            </div>
                        @endif-->
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::label('parts_desc', __('garage::lang.parts_desc') . ':') !!}
                                {!! Form::textarea('parts_desc', $job_sheet->parts_desc, ['class' => 'form-control ', 'rows' => '3']); !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('car_status', __('garage::lang.car_status') . ':') !!}
                                {!! Form::select('car_status', ['in'=>'in','out'=>'out'], $job_sheet->car_status, ['class' => 'form-control select2 w-100', 'placeholder' => __('messages.please_select'), 'required']); !!}
                            </div>
                        </div> 
                        <!--<div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::text('completed_on',  !empty($job_sheet->completed_on)? @format_datetime($job_sheet->completed_on) : null, ['class' => 'form-control required', 'id' => 'delivery_date', 'readonly']); !!}
                                    <span class="input-group-addon">
        ...
        <div class=" box box-solid pos-main-sec ct">
              <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="hidden" name="service_staff" value="{{ request()->session()->get('user.id')}}" >
                                    <input type="hidden" name="estimation" value="1" >
                                    <input type="hidden" name="contact_id" value="{{$job_sheet->contact_id}}" >
          ...
          <div class="box box-solid pos-main-sec ct">
              <div class="row">
                ...
                @endif
                    ...
                    <div class="col-md-6 excess_cost" @if(!$excess) style="display: none;" @endif>
                        <div class="form-group">
                            {!! Form::label('insurance_cost', __('garage::lang.insurance_cost') . ':') !!}
                            {!! Form::number('insurance_cost',$job_sheet->insurance_cost, ['class' => 'form-control ', 'id' => 'insurance_cost', 'placeholder' => __('garage::lang.insurance_cost'), 'rows' => 3]); !!}
                        </div>
                    ...
                    <div class="col-sm-6 col-sm-12 excess_desc" @if(!$excess) style="display: none;" @endif>
                        <div class="form-group">
                            {!! Form::label('insurance_desc', __('garage::lang.insurance_desc') . ':') !!}
                            {!! Form::textarea('insurance_desc',$job_sheet->insurance_desc, ['class' => 'form-control ', 'id' => 'insurance_desc', 'placeholder' => __('garage::lang.insurance_desc'), 'rows' => 3]); !!}
                        </div>
        ...
        <div class="box box-solid pos-main-sec ct">
              <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('comment_by_ss', __('garage::lang.repairs') . ':') !!}
                                {!! Form::textarea('comment_by_ss', $job_sheet->comment_by_ss, ['class' => 'form-control ', 'rows' => '3']); !!}
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('parts_desc', __('garage::lang.car_parts') . ':') !!}
                                {!! Form::textarea('parts_desc', $job_sheet->parts_desc, ['class' => 'form-control ', 'rows' => '3']); !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('amount', __('garage::lang.amount') . ':') !!}
                                    ...
                                    {!! Form::number('amount',  !empty($job_sheet->amount)? $job_sheet->amount : 0, ['class' => 'form-control required']); !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                {!! Form::label('delivery_date', __('garage::lang.repair_days') . ':') !!}
                                @show_tooltip(__('garage::lang.delivery_date_tooltip'))
                                <div class="input-group">
                                  
                                    {!! Form::text('repair_days',  !empty($job_sheet->repair_days)? $job_sheet->repair_days : null, ['class' => 'form-control required']); !!}
	...
	<tr class="media_row">
		...
		@endforeach	
                    ...
                    <div class="col-sm-12 text-right">
                        <input type="hidden" name="submit_type" id="submit_type">
                        <button type="submit" class="btn btn-success submit_button" value="save_and_send">
                        @lang('garage::lang.save_and_send_quote')
                        </button>
                        <button type="submit" class="btn btn-primary submit_button" value="submit">
                            @lang('messages.save')
                        </button>
            ...
            <div class="col-lg-12 hidden-pos-form">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('car_brand', __('product.brand') . ':') !!}
                            {!! Form::select('car_brand', $brands, null, ['class' => 'form-control select2 w-100', 'placeholder' => __('messages.please_select')]); !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
            ...
            <div class="col-lg-12 hidden-pos-form">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('type', __('garage::lang.type') . ':') !!}
                            {!! Form::select('type', ['OD'=>'OD','TP'=>'TP','REC'=>'REC'], null, ['class' => 'form-control select2 w-100', 'placeholder' => __('messages.please_select'), 'required']); !!}
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6 col-12 excess_desc" style="display: none;">
                        <div class="form-group">
                            {!! Form::label('insurance_desc', __('garage::lang.insurance_desc') . ':') !!}
            ...
            <div class="col-lg-12 hidden-pos-form">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('car_status', __('garage::lang.car_status') . ':') !!}
                            {!! Form::select('car_status', ['in'=>'in','out'=>'out'], null, ['class' => 'form-control select2 w-100', 'placeholder' => __('messages.please_select'), 'required']); !!}
                        </div>
                    </div> 
                    <div class="col-md-4">
                        <div class="form-group">
...
canvas.addEventListener('mousemove', draw);
    ...
    <script  type="text/javascript">
     ...
     if ($('textarea#cash_desc').length > 0) {
        ...
        if ($('textarea#comment_by_ss').length > 0) {
        tinymce.init({
            selector: 'textarea#comment_by_ss',
            height:250
        });
    }  
     if ($('textarea#parts_desc').length > 0) {
        tinymce.init({
            selector: 'textarea#parts_desc',
            height:250
        });
    }  
