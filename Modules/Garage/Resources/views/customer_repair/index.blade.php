...
<div class="login-form col-md-12 col-xs-12 right-col-content">
    <p class="form-header" style="border-bottom: 2px solid #2C0659;color:#2C0659 !important;">{{__('repair::lang.repair_status')}}</p>
    <form method="POST" action="{{action('\Modules\Repair\Http\Controllers\CustomerRepairStatusController@postRepairStatus')}}" id="check_repair_status">
        ...
        <div class="form-group">
    		<div class="input-group">
    			<div class="input-group-addon" style="background: #2C0659;"><i class="fas fa-microchip"></i></div>
            	<input type="text" name="serial_no" class="form-control" id="repair_serial_no" placeholder="@lang('repair::lang.serial_no')">
    		</div>
        </div>
        <div class="form-group">
	        <button type="submit" class="btn-login btn btn-flat ladda-button" style="background: #2C0659;color: #fff">
	        	@lang('lang_v1.search')
	       	</button>
	    </div>
   </form>
