...
class InstallController extends Controller
{
    ...
    {
        $this->module_name = 'garage';
        $this->appVersion = config('garage.module_version');
    }
    ...
    //    $action_url = action('\Modules\Garage\Http\Controllers\InstallController@install');
 ...
 try {
            ...
            // $license_code = "64fde2bb-5d98-4dcf-98bd-b21cad6a2c09";
            // $email = request()->email;
            ...
            $license_code = "64fde2bb-5d98-4dcf-98bd-b21cad6a2c09";
            $email = "info@mm4web.net";
            $login_username = "thewebfosters";
            $pid = 6;
            ...
            Artisan::call('module:migrate', ['module' => "Garage"]);
            System::addProperty($this->module_name . '_version', $this->appVersion);

            DB::commit();
            
            $output = ['success' => 1,
                    'msg' => 'Garage module installed succesfully'
                ];
        } catch (\Exception $e) {
            DB::rollBack();
...
//            $pid = 6;
    ...
    public function update()
    {
        ...
        try {
            ...
            $output = ['success' => 1,
                        'msg' => 'Garage module updated Succesfully to version ' . $this->appVersion . ' !!'
                    ];
