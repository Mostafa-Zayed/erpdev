...
Route::get('/superadmin/install', 'Modules\Superadmin\Http\Controllers\InstallController@index');
Route::group(['middleware' => ['web', 'auth', 'language', 'AdminSidebarMenu'], 'prefix' => 'superadmin', 'namespace' => 'Modules\Superadmin\Http\Controllers'], function () {
